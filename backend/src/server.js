...
app.get("/", (_req, res) => {
  res.sendFile(path.join(frontendLojaDir, "index.html"));
});
...
app.get("/loja/produto", (_req, res) => {
  res.sendFile(path.join(frontendLojaDir, "produto.html"));
});

app.get("/loja/pedidos", (_req, res) => {
  res.sendFile(path.join(frontendLojaDir, "pedidos.html"));
});

app.get("/loja/perfil", (_req, res) => {
  res.sendFile(path.join(frontendLojaDir, "perfil.html"));
});

app.get("/loja/politica", (_req, res) => {
  res.sendFile(path.join(frontendLojaDir, "politica.html"));
});
